...
public class Listofcafes extends AppCompatActivity {private RecyclerView recyclerView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cafeNames = new ArrayList<>();
        cafeAdapter = new CafeAdapter(this, cafeNames);
        recyclerView.setAdapter(cafeAdapter);

        databaseReference = FirebaseDatabase.getInstance().getReference("cafes");
