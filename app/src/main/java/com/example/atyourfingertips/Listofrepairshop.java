...
public class Listofrepairshop extends AppCompatActivity {private RecyclerView recyclerView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("repairshops");
