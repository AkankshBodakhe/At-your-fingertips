...
public class Railwaywebview extends AppCompatActivity {
    ...
    public class GeoWebChromeClient extends WebChromeClient {
        ...
        public void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback callback) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M ||
                    ContextCompat.checkSelfPermission(Railwaywebview.this, permission) == PackageManager.PERMISSION_GRANTED) {
                // that is you already implement, but it works only
                // we're on SDK < 23 OR user has ALREADY granted permission
                callback.invoke(origin, true, false);
            } else {
                if (ActivityCompat.shouldShowRequestPermissionRationale(Railwaywebview.this, permission)) {
                    ...
                    ActivityCompat.requestPermissions(Railwaywebview.this, new String[] {permission}, RP_ACCESS_LOCATION);
                }
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load google.com
        webView.loadUrl("https://www.google.com/maps/search/railway+station+near+me/");
    }
